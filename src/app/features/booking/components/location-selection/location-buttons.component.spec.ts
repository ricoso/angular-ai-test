...
describe('LocationButtonsComponent', () => {
  ...
  describe('Inputs', () => {
    ...
    it('should accept selectedLocation input', () => {
      ...
      fixture.componentRef.setInput('selectedLocation', location);
      fixture.detectChanges();
  ...
  describe('Outputs', () => {
    it('should emit locationSelected with location object', () => {
      const spy = jest.fn();
    ...
    it('should emit correct location for each selection', () => {
      const spy = jest.fn();
      component.locationSelected.subscribe(spy);
